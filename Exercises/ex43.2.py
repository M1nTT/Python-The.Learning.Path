...
class Engine(object):
    ...
    def __init__(self, scene_map):
        self.sceme_map = scene_map

    def play(self):
        current_scene = self.sceme_map.opening_scene()
        last_scene = self.sceme_map.next_scene('finished')

        while current_scene != last_scene:
            next_scene_name = current_scene.enter()
            current_scene = self.sceme_map.next_scene(next_scene_name)
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            You do a dive roll into the Weapon Armory, couch and scan
        ...
        print(f"Cheat Tips: code is {code}")
        guess = input("code> ")
        guesses = 0
        ...
        if guess == code:
            print(dedent("""
                The container clicks opn and the seal breaks, letting
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            them could be damaged but you don' have time to look.
            There's 5 pods, which one do you takes?
            """))
        
        good_pod = randint(1,5)
        print(f"Cheat Tips: good_pod is {good_pod}")
        guess = input("[pod #]> ")
